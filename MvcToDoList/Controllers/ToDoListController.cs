...
namespace MvcToDoList.Controllers
{
    public class ToDoListController : Controller
    {
        ...
        // GET: ToDoList
        public async Task<IActionResult> Index(string toDoListStatus, string searchString)
        {
        ...
        // GET: ToDoList/Today
        public async Task<IActionResult> Today( string toDoListStatus, string searchString)
        {
            // Use LINQ to get list of statuses.
            IQueryable<string> statusQuery = from t in _context.ToDoList
                                             orderby t.Status
        ...
        public async Task<IActionResult> UpcomingWeek( string toDoListStatus, string searchString)
        {
            // Use LINQ to get list of statuses.
            IQueryable<string> statusQuery = from t in _context.ToDoList
                                             orderby t.Status
        ...
        public async Task<IActionResult> Create([Bind("Id,Task,Description,Status,Comments,Created,CompleteBy")] ToDoList toDoList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Task,Description,Status,Comments, CompleteBy")] ToDoList toDoList)
        {
            if (id != toDoList.Id)
            {
                return NotFound();
